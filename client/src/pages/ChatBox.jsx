...
const ChatBox = () => {
  ...
  return user && (
    <div className='flex flex-col h-screen'>
      <div className='flex items-center gap-2 p-2 md:px-10 xl:pl-42 bg-gradient-to-r from-indigo-50 to-purple-50 to-purple-50 border-b border-gray-300'>
      ...
      <div className='p-5 md:px-10 h-full overflow overflow-y-scroll'>
