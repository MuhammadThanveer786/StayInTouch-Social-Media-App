            ...
            {/* profile picture */}
              ...
              <div>
               ...
               <div>
                  ...
                  <textarea rows={3} type="text" className='w-full p-3 border border-gray-200 rounded-lg' placeholder='please enter a short bio' onChange={(e)=>setEditForm({...editForm,bio:e.target.value})} value={editForm.bio} />
              ...
              <div>
                  <label className='block text-sm font-medium text-gray-700 mb-1'>
                   ...
                   <input type="text" className='w-full p-3 border border-gray-200 rounded-lg' placeholder='please enter your location' onChange={(e)=>setEditForm({...editForm,location:e.target.value})} value={location.username} />


              </div>

              <div className='flex justify-end space-x-3 pt-6'>
                <button onClick={()=>setShowEdit(false)} className='px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-colors cursor-pointer' >Cancel</button>
